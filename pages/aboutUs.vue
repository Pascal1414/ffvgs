  ...
  <div class="card w-full bg-base-200 shadow-xl mb-4">
    <div class="card-body">
      ...
      <div class="board flex flex-wrap justify-around gap-[25px]">
        <div
          v-if="boardPending && boardPersons === null"
          v-for="n in 10"
...
const { data: boardPersons, pending: boardPending } = await useLazyFetch(
...
const { data: vips, pending: vipsPending } = await useLazyFetch(
