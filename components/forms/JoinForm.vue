      ...
      <form name="join-association" method="POST" :action="config.public.formspree.joinFormUrl"
        ...
        <div class="card w-full bg-base-300 shadow-xl">
          <div class="card-body gap-0">
            ...
            <label v-for="(membership, index) in memberships" :key="index"
              class="label cursor-pointer gap-4 justify-start ">
              <input type="radio" name="membership" class="radio checked:bg-red-500" />
              <span class="label-text">{{ membership.name + ' (' + membership.price + ') ' + membership.age
                }}</span>
            </label>
          </div>
        </div>
        ...
        <div class="split-cols grid grid-cols-2 gap-[15px] mb-0 mt-3">
          <div>
            ...
            <label>
              ...
              <input name="birthdate" type="date" placeholder="Geburtsdatum" class="input input-bordered w-full"
                required />
            </label>
          ...
          <div>
            ...
            <label>
              ...
              <input name="street" type="text" placeholder="Strasse und Nummer" class="input input-bordered w-full"
                required />
            </label>
            ...
            <label>
              ...
              <input type="text" name="zip" placeholder="PLZ" class="input input-bordered w-full" required />
            </label>
            ...
            <label>
              ...
              <input name="place" type="text" placeholder="Ort" class="input input-bordered w-full" required />
            </label>
        ...
        <div class="mb-2">
          ...
          <label>
            ...
            <textarea name="message" class="textarea textarea-bordered w-full" placeholder="Nachricht"></textarea>
          </label>
